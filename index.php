...
<html  lang="en">
   ...
   <body
      ...
      <section id="about" class="about-section pt-120 pb-120 paralax__animation">
         <div class="container">
            <div class="row g-5">
      ...
      <section id="service" class="service-section pt-120 pb-120">
...
<!--                   <a class="btn-one wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" href="page-services.html">All Services</a>
 -->                  <figure class="arry wow bounceInRight" data-wow-delay="200ms" data-wow-duration="1500ms"><!-- 
      ...
      <!-- <section class="strategy-section">
         ...
         <div class="row g-5">
            ...
            <div class="col-xl-6 content-column">
               <div class="inner-column">
                  <div class="sec-title mb-30">
                     <h6 class="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Busines strategy</h6>
                     <h2 class="title wow splt-txt" data-splitting>Driving Success Through Tailored Solutions and Proven Expertise.</h2>
                  </div>
                  <div class="accordion-area">
                     <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                           <h2 class="accordion-header">
                              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Ensure Business Continuity </button>
                           </h2>
                           <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                              <div class="accordion-body">
                                 <p class="text">Drive innovation faster with world-class tech teams. We'll connect you with a fully remote team</p>
                              </div>
                           </div>
                        </div>
                        <div class="accordion-item">
                           <h2 class="accordion-header">
                              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Browser Safety & Protection </button>
                           </h2>
                        ...
                        <div class="accordion-item">
                           <h2 class="accordion-header">
                              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> Cutting-Edge IT Solutions </button>
                           </h2>
                        ...
                        <div class="accordion-item">
                           <h2 class="accordion-header">
                              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> Expert Guidance & Assistance </button>
                           </h2>
      ...
      <section id="news" class="blog-section pb-120">
         <div class="container">
            <div class="sec-title mb-50">
               ...
               <div class="flex-content">
                  ...
                  <a href="news-grid.html" class="btn-two wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">All news & Blogs</a>
               </div>
            </div>
                     ...
                     <div class="blog-block">
                        <div class="inner-box">
                           ...
                           <div class="content-box">
                              ...
                              <h4 class="title">
                                 <a href="news-details.html">Complete Guide Business Insurance perfect</a>
                              </h4>
                              <a href="news-details.html" class="arry-btn">
                                 Read More
                     ...
                     <div class="blog-block">
                        <div class="inner-box">
                           ...
                           <div class="content-box">
                              ...
                              <h4 class="title">
                                 <a href="news-details.html">How Scale Your Business Without Losing Quality</a>
                              </h4>
                              <a href="news-details.html" class="arry-btn">
                                 Read More
                                 <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div class="blog-block">
                        <div class="inner-box">
                           ...
                           <div class="content-box">
                              ...
                              <h4 class="title">
                                 <a href="news-details.html">The Entrepreneur Guide to Work-Life Balance</a>
                              </h4>
                              <a href="news-details.html" class="arry-btn">
                                 Read More
                                 <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
