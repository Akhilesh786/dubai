<footer id="contacts" class="main-footer footer-style-one">
         <div class="outer-box">
            <div class="footer-left">
               <div class="logo">
                  <a href="javascript:void(0)"><img src="images/logo_black.png" alt="Logo"></a>
               </div>
                        ...
                        <div class="col-lg-4">
                           <div class="info-item">
                              <ul>
                                 ...
                                 <li>
                                    <span>Call Us:</span>
                                    <h5 class="title"> +971 568586608</h5>
                                 </li>
                              </ul>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="info-item">
                              <ul>
                                 ...
                                 <li>
                                    <span>Email Us:</span>
                                    <h5 class="title">rishis@awesomepanama.com</h5>
                                 </li>
                              </ul>
                           </div>
                        </div>
