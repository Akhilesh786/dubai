                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Add Photos To This Category</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">All Photo</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
								...
								<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
									...
									<?php 
$i = 1; 
$stmt=$dbh->query("SELECT * FROM gallery WHERE gallery.cate_id='$cate_id' ORDER BY `gallery`.`g_id` DESC");
while ($row = $stmt->fetch()){ ?>
									
                                              <tbody>
						                        <tr role="row" class="odd">
                                                <td class="sorting_1"><?php echo $i++ ; ?></td>
                                                <td><img src="../<?php echo $row['image'] ; ?>" style="max-height:250px"/></td>
                                                <td> <form method="post" class="display_results" action="delete/delete_image.php" >
