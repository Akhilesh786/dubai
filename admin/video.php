                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12" style="display:">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
								    <form class="user" action="add/add_video.php" method="POST">
                                        <div class="form-group">
                                            <input type="text" name="video" class="form-control form-control-user" placeholder="Video Embed Link" required >
                                        </div>
                            ...
                            <div class="card shadow mb-4">
								...
								<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                    <thead>
										...
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: auto">Video</th>
									...
									<?php 
$i = 1; 
$stmt=$dbh->query("SELECT * FROM video");
while ($row = $stmt->fetch()){ ?>
                                              ...
                                              <tbody>
                                                ...
                                                <td>
                              <?php echo $row['path'];?></td>
											    <td><form method="post" class="display_results" action="delete/delete_video.php" >
