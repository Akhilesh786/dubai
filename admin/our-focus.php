...
<body id="page-top">
                       ...
                       <div class="col-xl-12 col-lg-12" style="display:">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Add New Our Focus</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
								   	<a href="add-focus.php" class="btn btn-primary btn-user btn-block">Add To Our Focus</a>
                        ...
                        <div class="col-xl-12 col-lg-12" style="display:">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">All From Our Focus</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
								    	<?php 	  $stmt=$dbh->query("SELECT * FROM focus ORDER BY `focus`.`id` DESC ");	 
	while ($row = $stmt->fetch()) { ?>    
    <!-- Blog Post -->      
	<div class="card mb-4 blog">        
	<img class="card-img-top" src="<?php echo $row['image']; ?>" alt="Card image cap" style="display:non; max-width:450px;">   
	<div class="card-body">           
	...
	<a href="edit-focus.php?id=<?php echo $row['id']; ?>" class="blog-link btn btn-primary">Edit This Blog Post &rarr;</a>	
	&nbsp; &nbsp; 			
	<form method="POST" action="delete/delete_focus.php">	
