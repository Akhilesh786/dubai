                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-12 col-lg-12" style="display:">
                        <div class="card shadow mb-4">
                           ...
                           <!-- Card Body -->
                           <div class="card-body">
                              <form method="POST" action="add/add_blog.php">
                                 <input type="hidden" name="name" value="<?php echo $name; ?>" />
                                 <input type="hidden" name="user_id" value="<?php echo $_SESSION['id']; ?>" />
                                  <div class="form-group">
								<span>HEAD IMAGE</span>
                                    <input type="file" name="thumbnail1" id="photo">
									<input type="hidden" name="thumbnail" class="get-photo"  value=""></br><b>Select an image as given ratio.</b> 
									
									<div class="uploaded_image">
									</div>
									<img src="../images/870x520.png" class="img-thumbnail" style="height:150px; width:auto;" />
									<div id="response"></div>
                                </div>
                                 <div class="form-group">
                                    <label for="usr"><strong>BLOG TITLE</strong></label>
								...
								<div class="form-group">
								 ...
								 <textarea name="Short_description" maxlength="255" class="form-control"  placeholder="Short Description" ></textarea>
								 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-3 mt-2">
                                       <div class="form-check">
                                          <input class="form-check-input checkbox" type="checkbox" value="<?php echo $rowblogcate['blog_cate_id']; ?>" id="defaultCheck<?php echo $rowblogcate['blog_cate_id']; ?>" >
                                 ...
                                 <hr>
                                 <div class="form-group">
                                    <label for="usr"><strong>BLOG CONTENT</strong></label>
    ...
    $('#photo').change(function () {
           ...
           img.onload = function() {
                  ...
                  if(imgwidth >= maxwidth && imgheight == maxheight){
                       ...
                       form_data.append("blog", document.getElementById('photo').files[0]);
						   $.ajax({
							...
							success:function(data)
							{
							 ...
							 $('.img-thumbnail').attr("src","../upload/blog/"+data);
      ...
      <script>
         ...
         tagInput1.addData(['awesomesauce']);
      </script>
      <script>
