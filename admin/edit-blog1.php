...
<body id="page-top">
	...
	<input type="hidden" value="<?php echo $blog_id ; ?>" name="blog-id" />
                            ...
                            <div class="form-group">
                                <label for="contact-name">Head Image</label> <br>
								<input type="file" class="photo-include" style="display:non" name="photo" id="photo" style="height:auto;" />
								<input type="hidden" class="get-photo" value="../upload/<?php echo $rowblog['blog_head_image'] ; ?>" name="blog-poster"/>
      <br /><br>
   <span class="uploaded_image_display"><img src="../upload/<?php echo $rowblog['blog_head_image'] ; ?>" class="img-thumbnail uploaded_image" style="display:non; max-width:450px;" /></span>
	...
	<input type="text" name="blog-description" class="form-control" value="<?php echo $rowblog['blog_description'] ; ?>" placeholder="Blog Meta Description" required />
	</div>
	<div class="form-group">
