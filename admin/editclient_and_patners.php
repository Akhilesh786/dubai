...
<html lang="en">
  <head>
    ...
    <title> Edit Clients_and_Partners</title>
        ...
        <div id="content"> <?php include "navbar.php"; ?>
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Edit Clients And Partners</h1>
            </div>
            <div class="row">
                      ...
                      <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
						  ...
						  <div class="">
								  ...
								  $new = $dbh->query("SELECT * FROM Clients_and_Partners where id='".$_GET['id']."'");
												$new1=$new->fetch();   ?>
							<div class="modal-body login-body">
                                        <div class="card shadow mb-4">
                                          ...
                                          <!-- Card Body -->
										  <div class="card-body">
                                            <form class="user update_admin" id="update"  method="POST">
                                              <input type="hidden" value="<?php echo $_GET['id'];?>" name="id">
                                              <div class="form-group">
                                                <input type="text" name="name" value="<?php echo  $new1["name"]; ?>" class="form-control form-control-user">
                                              </div>
                                              <div class="form-group" onchange="type();">
                                                <select name="type" id="type" class="form-control ">
                                                  <option>--Select Banner Type--</option>
                                                  <option value="1" <?php if($new1["type"]==1){ echo 'selected' ;}?>>Clients </option>
                                                  <option value="2" <?php if($new1["type"]==2){ echo 'selected' ;}?>>Partners </option>
                                                </select>
                                              </div>
											  <img src="upload/clients_partners/<?php echo $new1["thumbnail"]; ?>" style="height:150px; width:auto;" />
                                              <div class="form-group photo1" style="display:none;">
                                                ...
                                                <input type="text" name="thumbnail_Clients" class="get-Clients" value="<?php if($new1["type"]==1){ echo $new1["thumbnail"] ;}?>">
                                              ...
                                              <div class="form-group video1" style="display:none;">
                                                ...
                                                <input type="text" name="thumbnail_Partners" class="get-Partners" value="<?php if($new1["type"]==2){ echo $new1["thumbnail"] ;}?>">
    ...
    <script>
      $(document).ready(function() {
        $('#update').submit(function(e) {
          ...
          $.ajax({
            type: "POST",
            url: 'update/editclient_and_patners.php',
            data: $(this).serialize(),
            success: function(data) {
              alert(data);
              if (data==1) {
                window.location.href="Clients_and_Partners.php";
              }else{
              ...
              $.ajax({
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                      ...
                      $('.uploaded_video').html(" < label class = 'text-success' > Image Uploading... < /label>");
                        },
                        success: function(data) {
                          $('.uploaded_video').hide();
