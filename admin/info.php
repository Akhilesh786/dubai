             ...
             <?php include "navbar.php"; ?>
              ...
              <div class="container-fluid">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
								    <form class="user">
                                        <div class="form-group">
                                            <input type="text" name="email" class="form-control form-control-user" value="<?php echo $info_name; ?>" readonly >
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="email" class="form-control form-control-user" value="<?php echo $info_title; ?>" readonly >
                                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7" style="display:">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								...
								<div class="row">
								<div class="col-md-8">
								<img src="../<?php echo $info_logo ; ?>" style="max-width:100%" />
								</div>
								<div class="col-md-4">
								<a href="#" class="btn btn-google btn-block" data-toggle="modal" data-target="#myModal1">Edit</a>
								</div>
								</div>
                                </div>
                            </div>
