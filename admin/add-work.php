              ...
              <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12" style="display:">
							...
							<input type="text" name="work-head" class="form-control" placeholder="Work Title" required />
							</div>
							...
							<input type="text" name="team" class="form-control" placeholder="Enter Team Member With Space" required />
							</div>
							
							<div class="form-group">
							<label for="Work Category"><strong>Service</strong></label>
							<input type="hidden" name="service" class="cate-display" >
							<div class="row">
							<?php $stmt = $dbh->query("SELECT * FROM `work_cate` ORDER BY `work_cate`.`work_id` ASC");
							 ...
							 <div class="col-md-2 mt-2">
							   <div class="form-check">
								  <input class="form-check-input checkbox" type="checkbox" name="service_" value="<?php echo $row['work_id']; ?>" id="defaultCheck<?php echo $row['work_id']; ?>"  >
							...
							<div class="form-group">
							<input type="text" name="picsart" class="form-control"  placeholder="Enter pinterest Url"  />
							</div>
							
							<div class="form-group">
							<label for="usr"><strong>WORK CONTENT</strong></label>
							<textarea id="editor" name="work-content" class="form-control" style="height:650px;" placeholder="Write Your Content Here" required >
							</textarea>
							</div>
