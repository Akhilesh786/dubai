...
<html lang="en">
   <head>
      ...
      <title>Manage Client Position</title>
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                     <h1 class="h3 mb-0 text-gray-800">Client View </h1>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-xl-12 col-lg-12" style="display:">
						...
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                           ...
                           <div class="col-xl-12 col-lg-12" id="tabs" style="display: grid;grid-template-columns: repeat(2, 1fr);gap: 10px;align-content: center;">
