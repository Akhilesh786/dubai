                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12" style="display:">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
								    <form class="user" action="add/add_gallery_cate.php" method="POST">
...
while ($row = $stmt->fetch()){ ?>
                                              ...
                                              <tbody>
                                                ...
                                                <td><a href="add-image.php?id=<?php echo $row['cate_id']; ?>" class="btn btn-facebook btn-block">Add Images</a></td>
